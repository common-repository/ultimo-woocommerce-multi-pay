...
class WC_Stripe_Helper {
	...
	public static function get_localized_messages() {
		return apply_filters( 'wc_stripe_localized_messages', array(
			'invalid_number'           => __( 'The card number is not a valid credit card number.', 'ultimo-woomultipay' ),
			'invalid_expiry_month'     => __( 'The card\'s expiration month is invalid.', 'ultimo-woomultipay' ),
			'invalid_expiry_year'      => __( 'The card\'s expiration year is invalid.', 'ultimo-woomultipay' ),
			'invalid_cvc'              => __( 'The card\'s security code is invalid.', 'ultimo-woomultipay' ),
			'incorrect_number'         => __( 'The card number is incorrect.', 'ultimo-woomultipay' ),
			'incomplete_number'        => __( 'Your card number is incomplete.', 'ultimo-woomultipay' ),
			'incomplete_cvc'           => __( 'Your card\'s security code is incomplete.', 'ultimo-woomultipay' ),
			'incomplete_expiry'        => __( 'Your card\'s expiration date is incomplete.', 'ultimo-woomultipay' ),
			'expired_card'             => __( 'The card has expired.', 'ultimo-woomultipay' ),
			'incorrect_cvc'            => __( 'The card\'s security code is incorrect.', 'ultimo-woomultipay' ),
			'incorrect_zip'            => __( 'The card\'s zip code failed validation.', 'ultimo-woomultipay' ),
			'card_declined'            => __( 'The card was declined.', 'ultimo-woomultipay' ),
			'missing'                  => __( 'There is no card on a customer that is being charged.', 'ultimo-woomultipay' ),
			'processing_error'         => __( 'An error occurred while processing the card.', 'ultimo-woomultipay' ),
			'invalid_request_error'    => __( 'Could not find payment information. Please try with another payment method.', 'ultimo-woomultipay' ),
			'invalid_expiry_year_past' => __( 'Your card\'s expiration year is in the past', 'ultimo-woomultipay' ),
		) );
	}
