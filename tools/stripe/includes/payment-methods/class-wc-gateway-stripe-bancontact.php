...
class WC_Gateway_Stripe_Bancontact extends WC_Stripe_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title         = __( 'Stripe Bancontact', 'ultimo-woomultipay' );
		/* translators: link */
	...
	public function get_environment_warning() {
		if ( 'yes' === $this->enabled && ! in_array( get_woocommerce_currency(), $this->get_supported_currency() ) ) {
			$message = __( 'Bancontact is enabled - it requires store currency to be set to Euros.', 'ultimo-woomultipay' );
