...
class WC_Gateway_Stripe_Alipay extends WC_Stripe_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title         = __( 'Stripe Alipay', 'ultimo-woomultipay' );
		/* translators: link */
	...
	public function get_environment_warning() {
		if (
			...
			$message = sprintf( __( 'Alipay is enabled - it requires store currency to be set to %s', 'ultimo-woomultipay' ), implode( ', ', $this->get_supported_currency() ) );
