...
return apply_filters( 'wc_stripe_ideal_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: The Netherlands', 'ultimo-woomultipay' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#ideal" target="_blank">Payment Method Guide</a>', 'ultimo-woomultipay' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe iDeal', 'ultimo-woomultipay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'iDeal', 'ultimo-woomultipay' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'You will be redirected to iDeal.', 'ultimo-woomultipay' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
