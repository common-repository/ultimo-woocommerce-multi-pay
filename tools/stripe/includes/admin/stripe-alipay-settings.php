...
return apply_filters( 'wc_stripe_alipay_settings',
	array(
		'geo_target' => array(
			'description' => __( 'Relevant Payer Geography: China', 'ultimo-woomultipay' ),
			'type'        => 'title',
		),
		'guide' => array(
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#alipay" target="_blank">Payment Method Guide</a>', 'ultimo-woomultipay' ),
			'type'        => 'title',
		),
		'activation' => array(
		...
		'enabled' => array(
			...
			'label'       => __( 'Enable Stripe Alipay', 'ultimo-woomultipay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __( 'Alipay', 'ultimo-woomultipay' ),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __( 'You will be redirected to Alipay.', 'ultimo-woomultipay' ),
			'desc_tip'    => true,
		),
		'webhook' => array(
